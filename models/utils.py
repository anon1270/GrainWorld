...
#     cham_loss = cd()
#     # start_time_cd = time.perf_counter()
...
#     # elapsed_cd = time.perf_counter() - start_time_cd
#     # print(f'runtime of calculating loss_cd: {elapsed_cd} s')
...
#     # if return_raw:
#     #     # res.extend([dist1, dist2, idx1, idx2])
#     #     res = [loss, cd_p, cd_t, dist1, dist2, idx1, idx2]
